...
public class DatosJuego {
    ...
    public static void cargarDatos() throws SQLException {
    	...
    	protagonistas = new ArrayList<>(daoPersonaje.obtenerProtagonistas());
        enemigos = new ArrayList<>(daoPersonaje.obtenerEnemigos());
        secundarios = new ArrayList<>(daoPersonaje.obtenerSecundarios());
